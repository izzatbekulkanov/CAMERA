...
from .view.api import permanently_delete_user
from .view.user import (
    profile_view, users_list_view, import_users_view, get_groups, get_specialties,
    sync_employees_from_hemis, get_sync_progress, clear_employees,
    sync_students_from_hemis, clear_students, face_encoding_list_view, permanently_delete_user_view,
...
urlpatterns = [
    ...
    path(
        'users/delete-permanently/<int:user_id>/',
        permanently_delete_user_view,
